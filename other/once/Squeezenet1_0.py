...
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-128,-256,-256,-128,-128,-256,-1024])      # Base


# mask              = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-256,-512,-512,-512,-512,-2048])      # Case 1
# mask              = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-512,-512,-1024,-1024,-4096])      # Case 2
mask              = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-1024,-1024,-1024,-2048,-4096])      # Case 3

print(mask)    
_model = fuse_bn_recursively(models.squeezenet1_0(weights=models.SqueezeNet1_0_Weights.IMAGENET1K_V1)).to('cuda')# _model = fuse_bn_recursively(models.vgg19(weights=models.VGG19_Weights.IMAGENET1K_V1)).to('cuda')
