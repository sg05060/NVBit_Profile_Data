...
# Mobilenet_V2
mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-256,-256,-256,-256,-512,-512,-1024])       # Case 1
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-512,-512,-512,-512,-2048])       # Case 2
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-1024,-512,-1024,-512,-1024,-2048])    # Case 3
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-1024,-512,-1024,-1024,-1024,-2048])     # Case 4
#mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-256,-512,-512,-512,-2048])       # Case 5
print(mask)
# _model = fuse_bn_recursively(models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)).to('cuda')
...
for name, param in tqdm(model.named_parameters()):
    with torch.no_grad():
        ...
        param_save = np.save("/home/kkh/pytorch/data/MobileNet_V2_symbol/"+ name, Quant_input.cpu().numpy()) # per layer
...
total_param_save = np.save("/home/kkh/pytorch/data/MobileNet_V2_symbol/total.weight",parameters)
...
write_workbook.save('/home/kkh/pytorch/data/MobileNet_V2.xlsx')
result = []
