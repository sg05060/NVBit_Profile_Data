...
# Mobilenet_V2
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-256,-256,-256,-512,-512,-1024,-4096])       # Case 1
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-256,-256,-512,-512,-512,-2048,-4096])       # Case 2
mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-256,-512,-512,-1024,-2048,-8192])         # Case 3

# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-256,-512,-512,-1024,-2048,-4096])       # Case 5

print(mask)    
# _model = fuse_bn_recursively(models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)).to('cuda')

_model = fuse_bn_recursively(models.googlenet(weights=models.GoogLeNet_Weights.IMAGENET1K_V1)).to('cuda')
...
dataset = dsets.ImageFolder("/media/imagenet/val", models.GoogLeNet_Weights.IMAGENET1K_V1.transforms()) ### 2번째 인자, transform
