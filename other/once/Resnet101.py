...
# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-256,-512,-512,-1024,-4096])      # Case 1
mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-512,-512,-1024,-1024,-2048,-8192])      # Case 2

# mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-256,-256,-256,-128,-512,-512,-1024])        # Case 5


print(mask)    
_model = fuse_bn_recursively(models.resnet101(weights=models.ResNet101_Weights.IMAGENET1K_V1)).to('cuda')
...
dataset = dsets.ImageFolder("/media/imagenet/val", models.ResNet101_Weights.IMAGENET1K_V1.transforms()) ### 2번째 인자, transform
...
# write_workbook.save('/home/kkh/pytorch/data/Resnet_50.xlsx')
result = []
