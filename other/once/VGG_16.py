...
# VGG 19
mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-128,-256,-512,-1024,-1024,-1024,-1024,-1024,-4096]) # Case 5


mask            = torch.tensor([-1,-2,-4,-8,-16,-32,-64,-32,-16,-16,-8,-8,-16,-16,-32,-2048]) # Case 5

print(mask)    
# _model = fuse_bn_recursively(models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)).to('cuda')
_model = fuse_bn_recursively(models.vgg16(weights=models.VGG16_Weights.IMAGENET1K_V1)).to('cuda')
...
dataset = dsets.ImageFolder("/media/imagenet/val", models.VGG16_Weights.IMAGENET1K_V1.transforms()) ### 2번째 인자, transform
...
# write_workbook.save('/home/kkh/pytorch/data/VGG_19.xlsx')
result = []
